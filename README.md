...
## Bayesian Regression
The first model implemented. Takes some randomly generated correlated points and attempts to a find a line for which the points are most probably generated. 
